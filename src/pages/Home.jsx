    ...
    <>
      <section className="hero board">
        <div className="container hero-inner">
          <p className="eyebrow">
            مدیریت آموزش و پرورش مبارکه · معاونت آموزش ابتدایی
          </p>
          ...
          <div className="hero-actions">
            ...
            <Link className="btn btn-ghost" to="/arzeshyabi">
              راهنمای ارزشیابی
            </Link>
          </div>
      ...
      <section>
        <div className="container">
          <Reveal className="section-head">
            ...
            <h2>
              امروز دنبال <span className="u">چه هستید؟</span>
            </h2>

            <p className="lead">
              چهار مسیر، بسته به کاری که همین امروز روی میزتان است.
            </p>
          </Reveal>

          <div className="grid g4">
            {paths.map((p, i) => (
              <Card key={p.to} {...p} delay={i} />
            ))}
          </div>
        </div>
      </section>
